...
#     btn4 = types.KeyboardButton("Button 4")
...
# #
# #     elif message.text == 'Dollar kursi':
# #         s(message)  # Call the function to execute it
# #
# # def answer(message, current_question):
# #     print(message.text)
# #     if message.text.lower() == current_question['answer'].lower():
...
# from telebot import types
# import requests
# # from obHavo import weather_api
# bot = telebot.TeleBot("6602460824:AAFi7PBLivM0RMIEpAMTCWIJ5oXN-p-_OrI")
#
# @bot.message_handler(commands=['help'])
# def help(message):
...
#
#
# def weather_api(part=None):
#     lat = 41.6667
#     lon = 63.8333
#     APIkey = "04913d3529a596d1a9b6e6717ef409dc"
